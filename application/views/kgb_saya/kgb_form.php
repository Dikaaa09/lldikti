<div class="pagetitle">
    <div class="row">
        ...
        <div class="col-auto">
            <ol class="breadcrumb">
                <li class="breadcrumb-item fs-6"><a href="<?=site_url('kgb_saya')?>">KGB Saya</a></li>
                <li class="breadcrumb-item active fs-6"><?=$hal?> KGB Baru</li>
            </ol>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-auto">
                    <a href="<?=site_url('kgb_saya')?>" class="btn btn-warning btn-sm">
        ...
        <div class="card-body">
            ...
            <form action="<?=site_url('kgb_saya/process')?>" method="post">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="nip" value="<?=$row->nip?>" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <?php if ($this->fungsi->user_login()->level == 2) {?>
                                    <input type="hidden" class="form-control" name="pts" value="">
                                    <input type="text" class="form-control" name="pts" value=" - " disabled>
                                <?php }?>
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if ($this->fungsi->user_login()->level == 3) {?>
                                    <select class="form-select" name="jabatan" aria-label="Default select example" required>
                                        ...
                                        <option value="Lektor" <?=$row->jabatan == 'Lektor' ? "selected" : null ?>>Lektor</option>
                                        <option value="Profesor" <?=$row->jabatan == 'Profesor' ? "selected" : null ?>>Profesor</option>
                                        <option value="Rektor Kepala" <?=$row->jabatan == 'Rektor Kepala' ? "selected" : null ?>>Rektor Kepala</option>
                                        <option value="Tenaga Pengajar" <?=$row->jabatan == 'Tenaga Pengajar' ? "selected" : null ?>>Tenaga Pengajar</option>
                                    </select>
                                <?php }?>
                            </div>
                        </div>
