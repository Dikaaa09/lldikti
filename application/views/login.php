...
<head>
  ...
  <title>Login - LLDKTI WIL IX</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">LLDIKTI WIL IX</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="<?=site_url('auth/process')?>" class="row g-3 needs-validation" method="post">
