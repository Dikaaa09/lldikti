    ...
    <div class="row">
        ...
        <div class="col-auto">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item fs-6"><a href="<?=site_url('data_pegawai')?>">List KGB Terhapus</a></li>
                <li class="breadcrumb-item active fs-6">Detail</li>
            </ol>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="fullname" value="<?=$row->nama?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label"> : </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="gel_depan" value="<?=$row->gel_depan?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label"> : </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="gel_belakang" name="gel_belakang" value="<?=$row->gel_belakang?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label"> : </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="jabatan" value="<?=$row->jabatan?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label"> : </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="status_p" value="<?=$row->status_pegawai?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label"> : </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="gp_lama" value="<?=$row->gapok_lama?>" readonly>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label"> : </label>
                        <div class="col-sm-6">
                            <input type="date" class="form-control" name="tgl_skkp_lama" value="<?=$row->tgl_skkp_lama?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label"> : </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="no_skkp_lama" value="<?=$row->no_skkp_lama?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label"> : </label>
                        <div class="col-sm-6">
                            <input type="date" class="form-control" name="tmt_lama" value="<?=$row->tmt_skkp_lama?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="mk_tahun_lama" class="form-control" value="<?=$row->thn_mk_lama?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="input-group">
                                <span class="input-group-text">Bulan</span>
                                <input type="text" name="mk_bulan_lama" value="<?=$row->bln_mk_lama?>" class="form-control" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label"> : </label>
                        <div class="col-sm-6">
                            <input type="text" name="gp_baru" value="<?=$row->gapok_baru?>" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <span class="input-group-text">Tahun</span>
                                <input type="text" name="mk_tahun_baru" value="<?=$row->thn_mk_baru?>" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="input-group">
                                <span class="input-group-text">Bulan</span>
                                <input type="text" name="mk_bulan_baru" value="<?=$row->bln_mk_baru?>" class="form-control" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label"> : </label>
                        <div class="col-sm-6">
                            <input type="text" name="pangkat" value="<?=$row->pangkat?>" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label"> : </label>
                        <div class="col-sm-6">
                        <select class="form-select" name="golongan" aria-label="Default select example" readonly>
                    ...
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label"> : </label>
                        <div class="col-sm-6">
                            <input type="date" name="tmt_baru" value="<?=$row->tmt_skkp_baru?>" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label"> : </label>
                        <div class="col-sm-6">
                            <input type="date" name="tmt_kgb" value="<?=$row->tmt_next_kgb?>" class="form-control" readonly>
                        </div>
                    </div>
                </div>
            </div>
